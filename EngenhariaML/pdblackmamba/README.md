...
**R:** Salvei as metricas e parametros da preparação de dados e de treino do modelo na run do Mlflow com nome *metrics_dev*
...
**R:** As dimensoes da base de treino e teste (test_size e train_size) foram salvas como métrica no MLFLOW na run de nome *metrics_dev*. 
