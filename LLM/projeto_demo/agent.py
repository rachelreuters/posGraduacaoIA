...
# load_dotenv() 
# pedido = "Gostaria de viajar 2 dias para Santos em São Paulo. Gostaria de aproveitar a cidade e a região"
...
# coordinates =  re.sub(r"^```json|```$", "", response['coordinates']).strip()
# print(coordinates)